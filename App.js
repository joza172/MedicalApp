      ...
      <LinearGradient colors={['white', '#EBDDF6' ]} style={[styles.background, {flex:4}]}>
        ...
        <View style={{flexDirection: "column",flex: 6}}>
          <View style={{flexDirection: "row", flex: 1, justifyContent: "space-around", alignItems: "center"}}>
            <BigButton name="Vježbe" num="0" style={{ flex: 1}}></BigButton>
            <BigButton name="Razmazi" num="1" style={{ flex: 1}}></BigButton>
          </View>
          <View style={{flexDirection: "row", flex: 1, justifyContent: "space-around", alignItems: "center"}}>
            <BigButton name="Galerija" num="2" style={{ flex: 1}}></BigButton>
            <BigButton name="Bolesti" num="3" style={{ flex: 1}}></BigButton>
          </View>
        </View>
        <View style={{ flex: 1 }} >
